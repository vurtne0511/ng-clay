...
export const NC_MOMENT_DATE_ADAPTER_OPTIONS = new InjectionToken<NcMomentDateAdapterOptions>(
  'nc-moment-date-adapter-options', {
    providedIn: 'root',
    factory: NC_MOMENT_DATE_ADAPTER_OPTIONS_FACTORY
  });

/** @docs-private */
export function NC_MOMENT_DATE_ADAPTER_OPTIONS_FACTORY(): NcMomentDateAdapterOptions {
  return {
    useUtc: false
  };
}
...
export class MomentDateAdapter extends DateAdapter<Moment> {
  ...
  constructor(
    ...
    @Optional() @Inject(NC_MOMENT_DATE_ADAPTER_OPTIONS)
