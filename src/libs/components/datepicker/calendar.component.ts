...
export class NcDatePickerCalendar<D> implements AfterContentInit, OnChanges, OnDestroy {
  ...
  @Output() readonly viewChanged: EventEmitter<NcDatePickerViewType> =
    new EventEmitter<NcDatePickerViewType>(true);
  ...
  get currentView(): NcDatePickerViewType { return this._currentView; }
