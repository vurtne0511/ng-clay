...
@Component({
  ...
  host: {
    'class': 'nc-calendar-year'
  }
})
export class NcCalendarYear<D> implements AfterContentInit, OnDestroy {
  ...
  _monthSelected(event: NcCalendarUserEvent<number>) {
