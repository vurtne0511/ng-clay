...
// @dynamic
@Directive()
export abstract class NcDateSelectionModel<S, D = ExtractDateTypeFromSelection<S>>
...
@Injectable()
export class NcSingleDateSelectionModel<D> extends NcDateSelectionModel<D | null, D> {
...
@Injectable()
export class NcRangeDateSelectionModel<D> extends NcDateSelectionModel<DateRange<D>, D> {
  constructor(adapter: DateAdapter<D>) {
