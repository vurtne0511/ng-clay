...
export const NC_DATE_LOCALE = new InjectionToken<string>('nc-date-locale', {
  providedIn: 'root',
  factory: NC_DATE_LOCALE_FACTORY
});

/** @docs-private */
export function NC_DATE_LOCALE_FACTORY(): string {
...
export abstract class DateAdapter<D> {
   ...
   * the given value is already a valid date object or null. The `<nc-datepicker>` will call this
