export const FILE_EXTENSIONS_MAP: { [key: string]: any } = {
...
export const FILE_MIME_TYPES_MAP: { [key: string]: any } = {
...
export const NC_FILE_CATEGORIES: { [key: string]: string } = {
  ...FILE_EXTENSIONS_MAP,
  ...FILE_MIME_TYPES_MAP
};
...
export function findCategoryByFile(file: File) {
  ...
  return NC_FILE_CATEGORIES[type] || '';
}
