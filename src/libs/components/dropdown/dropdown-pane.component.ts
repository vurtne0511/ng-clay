...
export const NC_DROPDOWN_PARENT_COMPONENT = new InjectionToken<NcDropdownParentComponent>('nc-dropdown-parent-component');

@Component({
  selector: 'nc-dropdown-pane, [nt-dropdown-pane]',
...
export class NcDropdownPaneComponent implements AfterContentInit, OnDestroy {
  ...
  constructor(
    ...
    @Inject(NT_DROPDOWN_PARENT_COMPONENT) private _parent: NcDropdownParentComponent) {
  }
