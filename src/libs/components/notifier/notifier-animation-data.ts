 ...
 */
export interface NcNotifierAnimationPreset {
	/**
 ...
 */
export interface NcNotifierAnimationPresetKeyframes {
	/**
	 * CSS attributes before the animation starts
	 */
	from: { [animatablePropertyName: string]: string; };

	/**
	 * CSS attributes after the animation ends
	 */
	to: { [animatablePropertyName: string]: string; };
}
