...
const libPackage = require(`${rootFolder}/dist/@ng-clay/${lib}/package.json`);

const VERSION_PLACEHOLDER = '0.0.0-PLACEHOLDER'

const distFolder = join(rootFolder, 'dist/@ng-clay');
...
replaceFileContent(`${rootFolder}/dist/@ng-clay/${lib}/public-api.d.ts`, VERSION_PLACEHOLDER, version);
